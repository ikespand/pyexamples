...
class FindToilets():
    ...
    def build_query(self):
        query_part_1 = '[out:json][timeout:25];(node["amenity"="toilets"](around:'
        query_part_2 = str(self.radius)+','+str(self.lat)+',' + str(self.lon)
    ...
    def calculate_distance(lat1, lon1, lat2, lon2):
        """ Using the haversine formula, it has ~0.3% error built in.
        """
        ...
        a = math.sin(d_lat/2) * math.sin(d_lat/2) + \
            math.cos(lat1) * math.cos(lat2) * math.sin(d_lon/2) * \
            math.sin(d_lon/2)
...
if __name__ == "__main__":
    ...
    print(find_wc.__geo_interface__)
